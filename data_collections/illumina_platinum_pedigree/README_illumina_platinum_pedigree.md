...
Under this directory, the alignment data can be found in data/CEU and is organised by sample name (with both replicates present in the NA12882 directory). 
