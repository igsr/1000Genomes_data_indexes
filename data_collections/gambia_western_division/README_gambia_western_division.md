#Gambia Western Division README

This README contains information relating to data associated with the Gambia Western Division data set, files for which are available under this directory.  This data was generated by The Wellcome Trust Sanger Institute and is 4X coverage for four populations from Gambia Western Division (GWF). This data was submitted to ENA as part of a pre-publication release. For information on the proper use of pre-publication data shared by the Wellcome Trust Sanger Institute (including details of any publication moratoria), please see [http://www.sanger.ac.uk/datasharing/](http://www.sanger.ac.uk/datasharing/).
