...
This README contains information relating to data associated with the Gambia Western Division data set, files for which are available under this directory.  This data was generated by The Wellcome Trust Sanger Institute and is 4X coverage for four populations from Gambia Western Division (GWF). 
